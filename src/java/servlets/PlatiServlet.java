...
public class PlatiServlet extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        String nacinPlacanja=request.getParameter("plati");
        
        String info=(String)request.getAttribute("info");
        
        //Kupljenje registrovanog korisnika iz sesija koji je pristupio kupovini zarad upisa njegovih podataka u formu
        ...
        {         
             ...
             out.println("<title>Plati Servlet</title>");           
    ...
    out.println("<body>");      
           ...
           out.println("<br><br>");                   
            ...
            out.println("<center><h2 style=\"color:white;\"><u>PLAĆANJE</u></h2></center>");
            out.println("<center>");
            if(info!=null)
            {
            ...
            {
                out.println("<p style=\"color:white;\"><b><i>Morate odabrati način plaćanja!</i></b></p>");
                out.println("<p><a  href=\"prikazKorpe.jsp\">Vratite se na stranu sa računom</a></p>");
            }
            else
            {
               out.println("<table border=\"1\"  style=\"background-color:blue; color:white; border-color:black; border-radius:4px;\">");
               out.println("<tr><td>ODABRANI NAČIN PLAĆANJA=</td><td>"+nacinPlacanja+"</td></tr>");  
               out.println("</table ><br>");
            }
             out.println("<h3 style=\"color:white;\">Podaci o kupcu</h3>");
             out.println("<form action=\"ServletKupac\"  method=\"POST\">");
             out.println("<table border=\"1\" align=\"center\"  style=\"background-color:blue; color:white; border-color:black; border-radius:4px;\">");
             out.println("<tr>");
             out.println("<td align=\"center\">IME</td><td align=\"center\">PREZIME</td><td align=\"center\">ADRESA</td><td align=\"center\">GRAD</td><td align=\"center\">TELEFON</td><td align=\"center\">PIN</td>");            
             out.println("</tr>");
             
             if(kor!=null)
             {
                   out.println("<tr><td><input type=\"text\" name=\"ime\" value="+kor.getIme()+" /></td>"            
                    +"<td><input type=\"text\" name=\"prezime\" value="+kor.getPrezime()+" /></td>"
                    + "<td><input type=\"text\" name=\"adresa\" value="+kor.getAdresa()+" /></td><td><input type=\"text\" name=\"grad\" value="+kor.getGrad()+" /></td>"
                    + "<td><input type=\"text\" name=\"telefon\" value="+kor.getTelefon()+"  /></td>"
                    +"<td><input type=\"text\" name=\"pin\"   /></td>");           
                    out.println("</tr>"); 
             }
             else
             {
                 out.println("<tr><td><input type=\"text\" name=\"ime\"  /></td>"            
                    +"<td><input type=\"text\" name=\"prezime\"  /></td>"
                    + "<td><input type=\"text\" name=\"adresa\"  /></td><td><input type=\"text\" name=\"grad\"  /></td>"
            ...
            out.println("<tr>");
            out.println("<td colspan=\"6\" align=\"center\"><input type=\"submit\" value=\"Unesi podatke\"  style=\"background-color: grey; color:white; border-radius: 4px;\"/> </td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</form>");
             out.println("<br><br>");
