 ...
 * @author Mladen
 */
public class BrisiSjedisteServlet extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
           Class.forName("com.mysql.jdbc.Driver");
               ...
               String upit="DELETE FROM sjedista WHERE idSjedista= ?";
               
               PreparedStatement ps=konekcija.prepareStatement(upit);
               
               int idSjedista=Integer.parseInt(request.getParameter("idSjedista"));
               
               ps.setInt(1, idSjedista);               
               ps.executeUpdate();
               
               request.setAttribute("info","Uspješno izbrisano sjedište!");
