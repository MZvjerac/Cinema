...
<html>
    <head>
        ...
        <title>Podaci o rezervisti</title>
...
<center>
    <h2 style="color:white"><u>POTVRDA REZERVACIJE ZA:</u></h2>   
    <br>      
     <%
       ...
       <%}%>
        ...
        <table border="1" align="center" style="color:white; width: 325px;">
            ...
            <tr>  
                <td>REZERVACIJA VAŽI DO</td><td>${k.rezervacija}</td>
            </tr>
            <tr><td colspan="2" align="center"></td></tr>
        </table>
    <a href="OtkaziServlet" class="btn btn-secondary" >OTKAŽI</a>
</center>
    <br><br><br><br>
