<%-- 
    Document   : prikazKorpe
    Created on : Aug 16, 2020, 4:00:52 PM
    Author     : Mladen
--%>
...
<center>
    ...
    <form action="PlatiServlet" method="POST">
        <table border="1" align="center" style="color:white; width: 325px;">
            <tr>  
                <td align="center">Način plaćanja</td>
                <td>
                        <input type="radio" name="plati" value="American">American<br>
                        <input type="radio" name="plati" value="Dina">Dina<br>
                        <input type="radio" name="plati" value="Master">Master<br>
                        <input type="radio" name="plati" value="Visa">Visa<br>
                        
                    </td>
            </tr>
            <tr>
                <td colspan="2" align="center"><input type="submit" name="submit" value="POTVRDI" id="submit"/></td>
            </tr>
        </table>
    </form>
</center>
