<%-- 
    Document   : izvmng
    Created on : Aug 25, 2020, 10:41:54 AM
    Author     : Mladen
--%>



<%@page import="beans.Prijedlozi"%>
...
chart.render();
        ...
        <title>Izvještaj za menadžera</title>
...
<!--KRAJ NAVBARA-->    
    ...
    <center>    
    <h2 style="color:white"><u>PREGLED IZVJEŠTAJA</u></h2> <br> 
    </center>
   ...
   <div class="row">  
      ...
      <div class="col-sm-6 col-md-9">
       ...
       <div class="col-sm-6 col-md-3"><p style="color:white;"> 
               <u><p style="color:white; font-size: 18px; font-style: bold;">Prijedlozi od administratora :</p> </u>
           <% ArrayList<Prijedlozi> lP=(ArrayList<Prijedlozi>)request.getAttribute("listaPrijedloga"); %>   
               <% for(Prijedlozi p:lP) 
               {%>
               <p style="color:white; background-color: orange;"><%=p.getPrijedlog() %></p>
              <% }%>             
