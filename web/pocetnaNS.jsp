<%-- 
    Document   : pocetnaNS
    Created on : Aug 25, 2020, 9:08:08 PM
    Author     : Mladen
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="JS/trazi.js"></script>         

        
        <style>
            body{background: url("slike/kinoNovi.jpg"); 
                 background-repeat: no-repeat;
                 background-attachment: fixed;
                 width:auto;}            
                           
            img{border-radius: 4px;}
            nav{height: 112px; width: auto;}
   ...
   <%
    ...
    <table>
        ...
        <tr>
         ...
         try
         {
             ...
             while(rs.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarNS?ispis=<%=rs.getDate("datum") %>"><%=rs.getDate("datum") %></a>
             <%          
             }               
            }
          catch(Exception ex)
         ...
         try
          {
             ...
             while(rs1.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarNS?ispis2=<%=rs1.getString("zanr") %>"><%=rs1.getString("zanr") %></a>               
             <%  
        ...
        try
         {
             ...
             while(rs2.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarNS?ispis3=<%=rs2.getString("reziser") %>"><%=rs2.getString("reziser") %></a>
             <%          
             }               
            }
          catch(Exception ex)
           ...
           <div class="row" style="padding-left:40px;">
              ...
              <div class="card-body">
                ...
                <p class="card-text"><%=f.getRecenzija()%></p>
                 ...
                 <a href="karta.jsp?idFilm=<%=f.getIdFilm()%>" class="btn btn-primary">Karta</a>
              </div>
              </div>
            </div>           
           </div>
    ...
    <% }%></div>
        <%}
           ...
           {%>
           <center><p style="color:white; background-color: blue; width: 420px; border-radius: 4px; ">↑   Kliknite na neki od filtera   ↑</p></center>
         <%}%>
...
<embed src="muzika/The Velvet Underground - Heroin (Funbox Karaoke).mp3" autoplay style="height: 45px; width: 420px; border-radius: 28px; opacity: 50%;">
    </body>
</html>
