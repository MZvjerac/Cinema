    ...
    <table>
        ...
        <tr>
         ...
         try
         {
             ...
             while(rs.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarServlet?ispis=<%=rs.getDate("datum") %>"><%=rs.getDate("datum") %></a>
             <%          
             }               
            }
          catch(Exception ex)
         ...
         try
          {
             ...
             while(rs1.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarServlet?ispis2=<%=rs1.getString("zanr") %>"><%=rs1.getString("zanr") %></a>               
             <%  
        ...
        try
         {
             ...
             while(rs2.next())
             {%>                  
              <a class="dropdown-item" href="RepertoarServlet?ispis3=<%=rs2.getString("reziser") %>"><%=rs2.getString("reziser") %></a>
             <%          
             }               
            }
          catch(Exception ex)
