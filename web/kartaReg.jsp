<%-- 
    Document   : kartaReg
    Created on : Aug 25, 2020, 2:36:26 PM
    Author     : Mladen
--%>
...
<!--KRAJ NAVBARA-->    
   ...
   <%
       ...
       <%}%>
    <center>
        <h2 style="color:white"><u>KUPITE ILI REZERVIŠITE KARTU</u></h2>
        
        <small style="color:white">(Kupovinom u iznosu između 1000 i 3000 din. ostvarujete popust od 10%, a iznad 3000 din. 20%)</small>
    </center>     
    <br>      
    ...
    <div class="form-group"> 
                    ...
                    {%>    
                        ...
                        <a href="SalaServlet?ispis1=<%=rs.getInt("idFilm")%>" class="form-control btn btn-secondary">POGLEDAJTE SJEDIŠTA ►</a>
                        <br><br>
                        <a href="rezervacijaKarte.jsp?idFilm=<%=rs.getInt("idFilm")%>" class="form-control btn btn-secondary" >Rezervišite kartu</a>
                     <%          
                        }               
                    }
                    catch(Exception ex)
          ...
          <div class="col-md-8">
              <br>
              <center>
                <form action="KupiKartuServlet" method="POST">
                    <button type="submit" class="btn btn-secondary" name="submit">Kupite kartu</button>
